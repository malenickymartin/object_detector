...
def generate_object_transform(object_name, camera):
...
def generate_camera(res):
    # Generate random cameras
    
    fl = np.random.normal(700, 50)
    fl = np.clip(fl, 300, 900)

    # Save cams to json file
    cam = {"K":[[fl, 0.0, res[1]/2], [0.0, fl, res[0]/2], [0.0, 0.0, 1.0]], "resolution":res}
    return cam
...
if __name__ == "__main__":
    ...
    # Generate and save random viewpoints
